...
export default function AutomotiveWebDesignsPage() {
  return (
    ...
    >
      ...
      <main className="bg-background pt-32 text-foreground">
        <section className="mb-40 px-12">
          <div className="mx-auto max-w-7xl">
            <div className="mb-24 flex flex-col gap-16 md:flex-row md:items-end">
              <h1 className="font-headline text-[clamp(4rem,10vw,8rem)] font-black uppercase leading-[0.85] tracking-[-0.04em] text-heading">
                Automotive
                <br />
                <span className="text-[#b8c2d4]">Web Designs</span>
              </h1>
              <div className="pb-4 md:max-w-md">
            ...
            <div className="grid grid-cols-1 gap-8 border-t border-outline-variant/20 pt-16 md:grid-cols-3">
              {goals.map((goal) => (
                <div key={goal.title} className="group">
        ...
        <section className="relative mb-48 overflow-hidden">
          <div className="flex min-h-[819px] flex-col items-stretch md:flex-row">
            <div className="group relative w-full md:w-3/5">
              <Image
                alt="Mitsubishi homepage design preview"
                className="h-full w-full object-cover grayscale transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:grayscale-0"
                height={1600}
                src="/mitsubishi.png"
                width={2200}
              />
            ...
            <div className="relative z-10 flex w-full flex-col justify-center bg-surface-container px-12 py-24 md:w-2/5 md:py-0">
              <span className="mb-6 font-label text-[10px] tracking-[0.2em] text-[#d94343]">
                HOMEPAGE / 001
              </span>
              <h2 className="mb-8 font-headline text-5xl font-black uppercase leading-none tracking-tighter md:text-7xl">
                Mitsubishi
              </h2>
              <p className="mb-12 max-w-sm leading-relaxed text-on-surface-variant">
              ...
              <a
                className="inline-flex w-fit items-center justify-center rounded-md bg-[linear-gradient(135deg,#c72424_0%,#ff5a4d_100%)] px-8 py-4 font-label text-xs font-bold uppercase tracking-widest !text-[#171717] shadow-lg shadow-[#c72424]/20"
        ...
        <section className="mb-48 bg-surface-container-low px-12 py-32">
          <div className="mx-auto flex max-w-7xl flex-col items-center gap-24 md:flex-row-reverse">
            ...
            <div className="w-full md:w-1/2">
              <span className="mb-6 block font-label text-[10px] tracking-[0.2em] text-[#ffd34d]">
                HOMEPAGE / 002
              </span>
              <h2 className="mb-8 font-headline text-5xl font-black uppercase leading-none tracking-tighter md:text-7xl">
                Chevrolet
              ...
              <a
                className="inline-flex w-fit items-center justify-center rounded-md bg-[linear-gradient(135deg,#ffcc29_0%,#ffe27d_100%)] px-10 py-5 font-label text-xs font-bold uppercase tracking-widest !text-[#171717] shadow-lg shadow-[#ffcc29]/20"
        ...
        <section className="relative mb-64 overflow-hidden">
          <div className="flex min-h-[819px] flex-col items-stretch md:flex-row">
            <div className="group relative w-full md:w-3/5">
              <Image
            ...
            <div className="relative z-10 flex w-full flex-col justify-center bg-surface-container px-12 py-24 md:w-2/5 md:py-0">
              ...
              <a
                className="inline-flex w-fit items-center justify-center rounded-md bg-[linear-gradient(135deg,#2d6dff_0%,#73a7ff_100%)] px-8 py-4 font-label text-xs font-bold uppercase tracking-widest !text-[#171717] shadow-lg shadow-[#2d6dff]/20"
