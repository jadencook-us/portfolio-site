  ...
  return (
    ...
    >
      ...
      <main className="bg-background pt-24 text-foreground sm:pt-32">
        <section className="mb-24 px-6 sm:mb-40 sm:px-12">
          <div className="mx-auto max-w-7xl">
            <div className="mb-16 flex flex-col gap-10 sm:mb-24 sm:gap-16 md:flex-row md:items-end">
              <h1 className="font-headline text-[clamp(3.2rem,14vw,8rem)] font-black uppercase leading-[0.85] tracking-[-0.04em] text-heading">
                Automotive
                <br />
        ...
        <section className="relative mb-24 overflow-hidden sm:mb-48">
          <div className="flex min-h-[auto] flex-col items-stretch md:min-h-[819px] md:flex-row">
            ...
            <div className="relative z-10 flex w-full flex-col justify-center bg-surface-container px-6 py-10 sm:px-12 sm:py-16 md:w-2/5 md:py-0">
        ...
        <section className="mb-24 bg-surface-container-low px-6 py-16 sm:mb-48 sm:px-12 sm:py-32">
        ...
        <section className="relative mb-28 overflow-hidden sm:mb-64">
          <div className="flex min-h-[auto] flex-col items-stretch md:min-h-[819px] md:flex-row">
            <div className="group relative w-full md:w-3/5">
              <Image
